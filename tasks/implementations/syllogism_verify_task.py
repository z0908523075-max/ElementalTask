...
Following Lampinen & Dasgupta (2024), we provide three class that differ on
consistency with typicality/world knowledge:
    ...
    - nonce: nonsense word isolate pure logical reasoning from world knowledge
"""
...
def create_syllogism_verify_task(
    ...
    """Create a SyllogismVerifyTask, optionally filtered to one class."""
    data = None
