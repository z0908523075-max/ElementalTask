#!/bin/bash
#SBATCH --job-name=eval_final_pythia_70m
#SBATCH --output=logs/eval_final_pythia_70m_%A_%a.out
#SBATCH --error=logs/eval_final_pythia_70m_%A_%a.err
...
CONFIG="/data/user_data/mengyan3/tir3/ElementalTask/eval_configs/pythia_70m_checkpoints_0b_1t_main.json"
OUTPUT_BASE="results/pythia_70m_continuous_final_iteration"
