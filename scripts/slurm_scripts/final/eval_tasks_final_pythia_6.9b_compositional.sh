...
#SBATCH --job-name=eval_final_pythia_6.9b_compositional
#SBATCH --output=logs/eval_final_pythia_6.9b_compositional_%A_%a.out
#SBATCH --error=logs/eval_final_pythia_6.9b_compositional_%A_%a.err
...
CONFIG="/u/glee4/ElementalTask/eval_configs/pythia_6.9b_checkpoints_0b_1t_main.json"
OUTPUT_BASE="results/pythia_6.9b_continuous_final_iteration_compositional"
