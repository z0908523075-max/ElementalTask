...
#SBATCH --job-name=eval_final_pythia_2.8b_elemental
#SBATCH --output=logs/eval_final_pythia_2.8b_elemental_%A_%a.out
#SBATCH --error=logs/eval_final_pythia_2.8b_elemental_%A_%a.err
...
CONFIG="/u/glee4/ElementalTask/eval_configs/pythia_2.8b_checkpoints_main.json"
OUTPUT_BASE="results/pythia_2.8b_continuous_final_iteration_elemental"
