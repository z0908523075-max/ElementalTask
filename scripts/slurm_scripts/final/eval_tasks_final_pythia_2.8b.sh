#!/bin/bash
#SBATCH --job-name=eval_final_pythia_2.8b
#SBATCH --output=logs/eval_final_pythia_2.8b_%A_%a.out
#SBATCH --error=logs/eval_final_pythia_2.8b_%A_%a.err
...
CONFIG="/data/user_data/mengyan3/tir3/ElementalTask/eval_configs/pythia_2_8b_checkpoints_0b_1t_main.json"
OUTPUT_BASE="results/pythia_2.8b_continuous_final_iteration"
