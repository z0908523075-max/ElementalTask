...
class TextFRCT:
    def __init__(self, data_path='dataset/TextFRCT.csv', eval_llm='gpt-4o-mini-2024-07-18', skip_subjective=False):
        ...
        # Define which class are subjective vs objective
    ...
    def evaluate(self, raw_predictions, save_file='results.csv'):
        ...
        for idx in tqdm(range(len(save_data))):
            ...
            # Skip subjective class if requested
        ...
        for row in save_data:
            ...
            # Skip subjective class if they were skipped
        ...
        # filter out empty class (skipped subjective ones)
        filtered_accuracy = {}
        for subtest in accuracy:
            if accuracy[subtest]:  # Only include class that have data
